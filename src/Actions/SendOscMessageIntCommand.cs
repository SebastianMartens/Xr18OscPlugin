...
public class SendOscMessageIntCommand : ActionEditorCommand
{
    public SendOscMessageIntCommand()
    {
        ...
        ActionEditor.AddControlEx(
            new ActionEditorTextbox("DisplayText", "Display Text", "The label shown on the button.")
            .SetPlaceholder("ch01 compressor off")
            .SetRequired()
        );
    ...
    protected override string GetCommandDisplayName(ActionEditorActionParameters actionParameters) => actionParameters.GetString("DisplayText");
}
