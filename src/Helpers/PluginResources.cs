...
internal static class PluginResources
{
    ...
    // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.Xr18OscPlugin.Resources`.
    // Returns the full names of the resource files, for example, `Loupedeck.Xr18OscPlugin.Resources.Resource.txt`.
